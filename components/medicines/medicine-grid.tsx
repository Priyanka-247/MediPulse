...
const medicines = [
  {
    ...
    price: 25.5,
    originalPrice: 30.0,
    image: "/images/paracetamol-tablet.jpg?height=200&width=300&text=Paracetamol+500mg",
  ...
  },
  {
    ...
    price: 85.0,
    originalPrice: 95.0,
    image: "/images/amoxicillin-capsules-250-mg.jpeg?height=200&width=300&text=Amoxicillin+250mg",
    category: "Antibiotic",
  ...
  },
  {
    ...
    price: 45.0,
    originalPrice: 50.0,
    image: "/images/cetirizine-10-mg-tablet.jpg?height=200&width=300&text=Cetirizine+10mg",
    category: "Allergy",
    prescriptionRequired: false,
    inStock: true,
    rating: 4.7,
  ...
  },
  {
    ...
    price: 120.0,
    originalPrice: 140.0,
    image: "/images/omerprazole.jpg?height=200&width=300&text=Omeprazole+20mg",
    category: "Gastric",
    prescriptionRequired: true,
    inStock: false,
    rating: 4.4,
  ...
  },
  {
    ...
    price: 35.0,
    originalPrice: 42.0,
    image: "/images/ibuprofen-400-mg-bp-tablets.jpg?height=200&width=300&text=Ibuprofen+400mg",
    category: "Pain Relief",
    prescriptionRequired: false,
    inStock: true,
    rating: 4.2,
  ...
  },
  {
    ...
    price: 65.0,
    originalPrice: 75.0,
    image: "/images/metformin-500mg-tablet.jpg?height=200&width=300&text=Metformin+500mg",
    category: "Diabetes",
    prescriptionRequired: true,
    inStock: true,
    rating: 4.6,
  ...
  },
  {
    ...
    price: 180.0,
    originalPrice: 200.0,
    image: "/images/vitamin D31001U.webp?height=200&width=300&text=Vitamin+D3+1000IU",
    category: "Vitamins",
    prescriptionRequired: false,
    inStock: true,
    rating: 4.8,
  ...
  },
  {
    ...
    price: 28.0,
    originalPrice: 32.0,
    image: "/images/aspirin.png?height=200&width=300&text=Aspirin+75mg",
  ...
  },
  {
    ...
    price: 55.0,
    originalPrice: 65.0,
    image: "/images/claritin-pdp-hero-24h-tablets-10ct-front-1200x1154.avif?height=200&width=300&text=Loratadine+10mg",
    category: "Allergy",
    prescriptionRequired: false,
    inStock: true,
    rating: 4.5,
  ...
  },
  {
    ...
    price: 95.0,
    originalPrice: 110.0,
    image: "/images/simvastatin.webp?height=200&width=300&text=Simvastatin+20mg",
    category: "Cardiovascular",
    prescriptionRequired: true,
    inStock: true,
    rating: 4.3,
  ...
  },
  {
    ...
    price: 75.0,
    originalPrice: 85.0,
    image: "/images/shelcal-500-tablet.webp?height=200&width=300&text=Calcium+500mg",
    category: "Vitamins",
    prescriptionRequired: false,
    inStock: true,
    rating: 4.4,
  ...
  },
  {
    ...
    price: 125.0,
    originalPrice: 140.0,
    image: "/images/Dextromethorphan100mg_Syrup.png?height=200&width=300&text=Cough+Syrup",
    category: "Cough & Cold",
    prescriptionRequired: false,
    inStock: true,
    rating: 4.2,
